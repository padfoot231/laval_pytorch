...
# Saving model using state_dict, loading the parameters instead of whole model
...
for i in range(32):
    ...
    print("batch accurate prediction out of 128 Samples ",correct)
    total += int(correct)
print("accurate prediction out of 4200 Samples ", total)
